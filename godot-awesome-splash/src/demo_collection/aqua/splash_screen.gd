...
@export var logo_path: String = "res://src/demo_collection/aqua/assets/logo.png" # (String, FILE)
...
func config():
	...
	title_node.font_size = title_font_size
	title_node.modulate = font_color
	title_node.text = title
	
	info_node.font_size = description_font_size
